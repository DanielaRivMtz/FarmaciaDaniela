...
function NuevoPromoModal() {
    return (
        <div className="modal fade" id="NuevoPromoModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header bg-success">
                        <h5 className="modal-title" id="exampleModalLabel">Nueva Promoción</h5>
...
export default NuevoPromoModal